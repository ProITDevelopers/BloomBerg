...
const val msgAlgumProblemaResdesSoiciais = "Algum problema aconteceu.Tente outra forma de inicio de sessão."
const val msgAlgumCancelamento = "Operação cancelada."
