...
/*data class `proitdevelopers.com.bloomberg.basededados.entitys.Noticia`(var titulo: String, var descricao:String, var conteudo:String,
...
object valoresNoticias{
    val noticias = mutableListOf(
        Noticia("1","Apple, Foxconn Broke a Chinese Labor Law to Build Latest iPhones","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("2","Futuros de ações dos EUA avançam em meio a apostas: estímulo aos mercados","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("3","Old Mutual novamente impede que seu CEO volte ao trabalho","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("4","Principais produtores de cacau deixam marfinenses intrigados com o ministério do arroz","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("5","Naspers Amsterdam Foray alivia dores para os gestores de fundos da África do Sul","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("6","Ferrari lança dois novos modelos de aranha em um ano recorde de lançamento","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("7","Bugatti na busca de financiamento por Stablemate de 4 lugares para Quíron","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("8","Parlamento britânico será suspenso na segunda-feira: atualização do Brexit","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("9","Uma recessão na fabricação pode custar a Trump um segundo mandato","Universidade Metodista de Angola lança 650 licenciados",
        ...
        Noticia("10","O novo presidente do Alibaba diz que ele precisa reinventar o varejo antes que alguém o faça","Universidade Metodista de Angola lança 650 licenciados",
